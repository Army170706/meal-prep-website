...
const menus = [
    ...
    { name: "Capcay", icon: "🥦", ingredients: ["sawi putih", "1 wortel","4 siung bawang merah", "2 siung bawang putih", "5 bakso", "1 bks lada"], price: "Rp 15.000" },
    { name: "Cah Kangkung", icon: "🥬", ingredients: ["1 ikat kangkung", "2 siung bawang putih", "3 cabai", "3 siung bawang merah"], price: "Rp 13.000" },
    { name: "Daun Ubi ", icon: "🥥", ingredients: ["1 ikat daun ubi", "1 bks bunga pepaya", "4 siung bawang merah", "2 siung bawang putih", "3 buah cabai", "1 bks terasi"], price: "Rp 14.500" },
    ...
    { name: "Paria + Telur", icon: "🥒", ingredients: ["3 buah paria", "1 butir telur", "2 buah cabai merah", "2 siung bawang putih", "3 siung bawang merah", "1 sachet kunyit bubuk"], price: "Rp 15.000" },
    ...
    { name: "Bakwan Jagung", icon: "🌽", ingredients: ["2 buah jagung", "1 buah wortel", "tepung sajiku", "2 siung bawang putih"], price: "Rp 15.000" },
    { name: "Ubi Rebus", icon: "🥔", ingredients: ["6 buah Ubi ungu"], price: "Rp 12.000"}
];
